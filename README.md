...
| onHoverColor                          | string            | onColor                                                                                  | The switch will take on this color when mouse is hovering over it and switch is checked. Only accepts hex-colors.                                                                                                         |
| offHoverColor                         | string            | offColor                                                                                 | The switch will take on this color when mouse is hovering over it and switch is _not_ checked. Only accepts hex-colors.                                                                                                   |
| onHoverHandleColor                    | string            | onHandleColor                                                                            | The handle of the switch will take on this color when mouse is hovering over it and switch is checked. Only accepts hex-colors.                                                                                           |
| offHoverHandleColor                   | string            | offHandleColor                                                                           | The handle of the switch will take on this color when mouse is hovering over it and switch is _not_ checked. Only accepts hex-colors.                                                                                     |
