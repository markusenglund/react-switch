...
| backgroundBorderStyle                 | string            | 'none'                                                                                       | The width of the background of the switch, measured in pixels.                                                                                                                                                            |
| disableBackground                     | bool              | false                                                                                       | The width of the background of the switch, measured in pixels.                                                                                                                                                            |
