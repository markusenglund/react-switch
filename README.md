...
| tabIndex                              | oneOf [-1, 0]     | 0                                                                                        | Set as an attribute of the embedded checkbox, allowing the component to be part of the tab flow in the page (0) or be skiped of the flow (-1)                                                                                                                            |
